...
Sample CMAQ files for demonstrating the AIDE data-access workflow are publicly available through the AIDE GitHub release at [https://github.com/DaiShiqin/AIDE/releases/tag/data-v1.0](https://github.com/DaiShiqin/AIDE/releases/tag/data-v1.0). Air-quality observations are available from [quotsoft.net/air](https://quotsoft.net/air/), and meteorological information can be accessed through [Windy.com](https://www.windy.com/).
